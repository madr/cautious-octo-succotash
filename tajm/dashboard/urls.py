...
from tajm.dashboard import views

urls = [
    url(r'^$', views.dashboard, name='dashboard'),
    url(r'^my/profile$', views.profile, name='my_profile'),
    url(r'^people/(?P<user_id>\d+)$', views.profile, name='profile'),
    url(r'^people/(?P<user_id>\d+)/activity$', views.user_activity, name='user_activity'),
    ...
    url(r'^this/week$', views.current_week_summary, name='this_week'),
    url(r'^year/(?P<year>\d+)/week/(?P<week_label>\d+)$', views.week_summary, name='week_summary'),
