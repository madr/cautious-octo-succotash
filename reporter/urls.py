...
urls = [
    ...
    url(r'^progress\/(?P<progress_id>\d+)/edit$', reporter_views.edit_progress, name='edit_progress'),
    url(r'^progress\/(?P<progress_id>\d+)/delete$', reporter_views.delete_progress, name='delete_progress'),
]