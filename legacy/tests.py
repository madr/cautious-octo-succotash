from common.models import Progress, Project, CustomerSite
from django.contrib.sessions.backends.base import SessionBase
from django.http import HttpRequest, HttpResponseRedirect, HttpResponse
from django.test import TestCase
from reporter.lib import ProgressEditForm
from reporter.lib import _year_week_day, ProgressForm
...
def _create_post_request_mock():
    CustomerSite.objects.get_or_create(domain="127.0.0.1", name="dev")[0]
...
def _create_progress_mock(request, note="bla bla"):
    site = CustomerSite.objects.get_or_create(domain="127.0.0.1", name="dev")[0]

    project = Project.objects.create(name="bla", site=site)
    project.save()
...
class DeleteViewTestCase(TestCase):
    def test_delete_progress_and_redirect_back(self):
        ...
        self.assertEqual(response.__getitem__("Location"), "/year/2013/week/1/day/6")


class ReportViewTestCase(TestCase):
    def test_reporter_redirects_to_the_requestpath_on_success(self):
        request = _create_post_request_mock()
...
class EditProgressViewTestCase(TestCase):
    ...
    def test_editprogress_redirects_to_the_form_date_on_success(self):
        ...
        self.assertEqual(response.__getitem__("Location"), "/year/2014/week/4/day/5")